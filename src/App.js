    ...
    >
      ...
      <header className="App-header">
        ...
        <div className="social-links">
          ...
          {/* SoundCloud */}
          <a href="https://soundcloud.com/" className="social-icon soundcloud" target="_blank" rel="noopener noreferrer" aria-label="SoundCloud">
          ...
          {/* Telegram */}
          <a href="https://t.me/" className="social-icon telegram" target="_blank" rel="noopener noreferrer" aria-label="Telegram">
